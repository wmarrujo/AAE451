...
S = convert(144.9, "ft^2", "m^2") # wing planform area
...
# ASSUMED PARAMETERS
ηpcruise = 0.85 # cruise efficiency
ηploiter = 0.85 # loiter efficiency
...
LDmax = 1/2 * 1/sqrt(CD0 / (pi * AR * e)) # L/D
print(LDmax)
...
while 1 < abs(W0 - W0guess) and iteration < 100:
    ...
    We = EmptyWeightFraction(W0guess) * W0guess
    Wf = W0 * FuelWeightFraction # mission fuel weight
    W0 = We + Wf + Wpay # gross weight
