...
[initialDAirplane, simulationD, finalDAirplane] = getAirplaneDesignData(airplaneName, DPS, designMission, silent=False)
[initialRAirplane, simulationR, finalRAirplane] = getReferenceMissionData(airplaneName, DPS, designMission, referenceMission, referenceMissionName="reference", silent=False)
